...
| [**ERA-5 Atmospheric Analysis**](https://github.com/danishmahmoodali/era5-atmospheric-analysis) | Exploring a 4-D global climate reanalysis grid (37 pressure levels, 0.25°) — memory-safe NetCDF handling, interpolation, multi-scale visualization | xarray, NetCDF, Matplotlib |
| [**Fashion-MNIST CNN Pipeline**](https://github.com/danishmahmoodali/fashion-mnist-cnn) | End-to-end image classification as CLI tools — validation, preprocessing, and a Keras CNN with leakage-safe class balancing | TensorFlow/Keras, OpenCV |
